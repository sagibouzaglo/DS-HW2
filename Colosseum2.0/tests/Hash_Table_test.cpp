...
int main() {
    Training_Group* group1 = new Training_Group(15);
    Training_Group* group2 = new Training_Group(8);
    Training_Group* group3 = new Training_Group(4);;
    Training_Group* group4 = new Training_Group(770);
    Training_Group* group5 = new Training_Group(142);
    Training_Group* group6 = new Training_Group(24);
    Training_Group* group7 = new Training_Group(6);
    Training_Group* group8 = new Training_Group(40);
